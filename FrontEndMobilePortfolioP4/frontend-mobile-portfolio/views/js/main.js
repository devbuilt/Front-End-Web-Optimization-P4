...
var resizePizzas = function(size) {
	...
	/* Inificient Function below is new function
	...
	function changePizzaSizes(size) {
			...
			// replaced querySelectorAll with getElementsByClassName line 254-260
			//Fixed typo missing period in front of .randomPizzaContainer Line 255-260
...
function updatePositions() {
	...
	for (var i = 0; i < items.length; i++) {
		var phase = Math.sin((cachedScrollTop / 1250) + (i % 5));//removed document.body and added "cachedScrollTop"
...
document.addEventListener('DOMContentLoaded', function() {
	var cols = 8;
	var s = 256;
	var movingPizzas = document.getElementById('movingPizzas1');//added document.getElementById() Web API call is faster.
	for (var i = 0; i < 25; i++) {
		console.log((i),"pizza");
		...
		movingPizzas.appendChild(elem); //document.querySelector("#movingPizzas1").appendChild(elem);
	}
	updatePositions();
});
